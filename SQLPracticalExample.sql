...
VALUES
    ('952003', 'Urban', 'Urban Region'),
    ('232003', 'Suburban', 'Suburban Region'),
    ('151123', 'Rural', 'Rural Region');

INSERT INTO Land (Title, LocationID, Detail, StartDate, EndDate)
VALUES
    ('Tay Ho', '123123', 'My Dinh in Urban Region', '2010-01-01', '2011-12-21'),
    ('Thanh Xuan', '121212', 'Hoai Duc in Suburban Region', '2013-02-01', '2023-02-20'),
    ('Hoang Mai', '131313', 'An Thuong in Rural Region', '2000-03-01', '2010-01-10');
